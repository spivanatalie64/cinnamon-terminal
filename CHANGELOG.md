...
- Nightly upstream merge from GNOME gnome-terminal into `unstable` branch
...
- **Breaking:** Project renamed from `gnome-terminal` to `cinnamon-terminal`
...
- (No upstream fixes diverged yet — tracking GNOME Terminal 3.97.1)
